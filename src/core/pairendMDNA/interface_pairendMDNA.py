...
import shutil
def PEMD(opts):
	normal_fastq_1=opts.normal_fq1
	normal_fastq_2=opts.normal_fq2
	...
	neoantigens_PairMatchDna(normal_fastq_1,normal_fastq_2,tumor_fastq_1,tumor_fastq_2,out_directory,genome,prefix,bwa_index,reference,cpu_thread,coverage,binding_aff_fc_cutoff,binding_affinity_cutoff,exp,fpkm_cutoff)	
print 'Done!'
